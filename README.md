...
The optional portfolio chat uses Qwen 3.5 0.8B, hosted by a custom Modal Web Function behind a Next.js API route. It is intentionally unavailable until deployment secrets are configured; see [docs/portfolio-chat.md](docs/portfolio-chat.md) for the architecture, Modal setup, and production rate-limit requirement.
